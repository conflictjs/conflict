...
export default function SelectMenu({
  ...
  if (children) {
    ...
    options = options.map(option => {
      return global.__ConflictViewParser(SelectOption, {
        value: option.value,
  ...
  return global.__ConflictViewParser("components_arr", null, global.__ConflictViewParser("component", props, options));
}
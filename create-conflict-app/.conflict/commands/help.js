...
export default new Command({
  ...
  execute: async (command, options, utils) => {
    command.view(new View(View.createElement("message", null, View.createElement("embeds", null, View.createElement("embed", {
      color: "#ff3333",
      image: {
    ...
    }, View.createElement("title", null, "Hello, world!"), View.createElement("description", null, "Welcome to **Conflict**."))))));
  }
});
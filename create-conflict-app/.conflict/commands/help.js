...
export default new Command({
  ...
  execute: async (command, options, utils) => {
    command.view((typeof View !== 'undefined' ? View.createElement : command.getView().createElement)(DomFrag, null, (typeof View !== 'undefined' ? View.createElement : command.getView().createElement)("embeds", null, (typeof View !== 'undefined' ? View.createElement : command.getView().createElement)("embed", {
      color: "#ff3333",
      image: {
